...
# Organized it some, and added stamina variables.
...
func check_is_dead():
	...
	if current_health <= 0 and was_dead == false:
		...
		#Since you make this check every phyisics frame the movement speed was always the same
		#no matter what you changed to it, now the sprint mechanic should work just fine - EC
		#movement_speed = 5.0
		diedscreen.visible = false
